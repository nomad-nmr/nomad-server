...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.TOGGLE_ACTIVE_INSTRUMENTS_SUCCESS:
      let updatedTableData = updateTableSwitch(
    ...
    case actionTypes.SET_INSTRUMENT_ID_EDITING:
      return { ...state, overheadCalc: { ...state.overheadCalc, instrId: action.payload } }

    case actionTypes.FETCH_OVERHEAD_START:
