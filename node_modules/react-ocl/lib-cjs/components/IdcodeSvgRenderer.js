...
function IdcodeSvgRenderer(props) {
  ...
  const [error, mol] = (0, _useHandleMemoError.useHandleMemoError)(() => OCL.Molecule.fromIDCode(idcode, coordinates), [OCL, idcode, coordinates]);
  if (error) {
...
var _default = /*#__PURE__*/(0, _react.memo)(IdcodeSvgRenderer);
