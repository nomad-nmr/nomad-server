...
export const getDataset = async (req, res) => {
  try {
    ...
    //correlations table (Summary) stored in DB by older NMRium is not compatible with version 22 data format
    //deleting correlations property from NMRium state does not remove ranges and zones
    //once dataset is open in NMRium correlations table can be regenerated by editing&saving a zone
